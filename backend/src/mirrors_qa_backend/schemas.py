...
ISO3166AlphaCode = Annotated[str, Field(min_length=2, max_length=2)]
...
class Mirror(BaseModel):
    ...
    country_code: ISO3166AlphaCode | None = None
    other_countries: list[ISO3166AlphaCode] | None = None
...
class Region(BaseModel):
    code: ISO3166AlphaCode
    name: str


class Country(BaseModel):
    code: ISO3166AlphaCode  # two-letter country code as defined in ISO 3166-1
...
class UpdateWorkerCountries(BaseModel):
    country_codes: list[ISO3166AlphaCode]
